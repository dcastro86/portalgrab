#!/usr/bin/env bash
# Drives sanguine's own start/stop helpers against the real user service, then restores its state.
...
# Already running (started by someone else): sanguine must neither claim nor stop it.
